...
def get_option_setter(model_name):
    ...
    model_cls = import_class_from_module('models.' + module_name + '_model', model_name + 'model', allow_case=True,
...
def create_model(opt):
    ...
    """
    module_name = opt.model_name.lower()
    model_cls = import_class_from_module('models.' + module_name + '_model', opt.model_name + 'model',
                                         allow_case=True,
                                         allow_underline=True)
    assert issubclass(model_cls, BaseModel)
