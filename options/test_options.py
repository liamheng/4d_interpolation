...
class TestOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--metrics_sort_mode', type=str, default='max', choices=['max', 'min'], help='when phase=val, choose best epoch by maximizing or minimizing metrics_as_sort_index')
        ...
        # ncc_window_size
        parser.add_argument('--ncc_window_size', type=int, default=7, help='the window size for ncc calculation during test time')
        parser.add_argument('--ncc_do_square', action='store_true', help='whether to square the intensities when calculating ncc during test time')
